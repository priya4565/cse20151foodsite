...
<head>
  ...
  <!-- Favicons-->
  <link rel="icon" href="https://cse20151eval.blob.core.windows.net/151storage/favicon-32x32.png" sizes="32x32">
  <!-- Favicons-->
  <link rel="apple-touch-icon-precomposed" href="https://cse20151eval.blob.core.windows.net/151storage/apple-touch-icon-152x152.png">
  <!-- For iPhone -->
  <meta name="msapplication-TileColor" content="#00bcd4">
  <meta name="msapplication-TileImage" content="https://cse20151eval.blob.core.windows.net/151storage/mstile-144x144.png">
  <!-- For Windows Phone -->
        ...
        <div class="navbar-fixed">
            <nav class="navbar-color">
                <div class="nav-wrapper">
                    <ul class="left">                      
                      <li><h1 class="logo-wrapper"><a href="index.php" class="brand-logo darken-1"><img src="https://cse20151eval.blob.core.windows.net/151storage/materialize-logo.png" alt="logo"></a> <span class="logo-text">Logo</span></h1></li>
                    </ul>				
                </div>
            </nav>
        </div>
        ...
        <ul id="slide-out" class="side-nav fixed leftside-navigation">
            ...
            <div class="row">
                <div class="col col s4 m4 l4">
                    <img src="https://cse20151eval.blob.core.windows.net/151storage/avatar.jpg" alt="" class="circle responsive-img valign profile-image">
                </div>
